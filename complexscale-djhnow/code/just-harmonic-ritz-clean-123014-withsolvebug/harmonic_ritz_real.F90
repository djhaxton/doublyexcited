...
!!   multsub            matrix vector multiplication subroutine.  arbitrary nonsymmetric.
!!                      multiples NN vectors.  must be programmed as 
!!                           multsub(in(lansize,NN),out(lansize,NN),NN,lansize)
!!   indotsub           dot product subroutine.
!!                      computes SYMMETRIC dot products between a set of NN vectors and one of MM vectors.
