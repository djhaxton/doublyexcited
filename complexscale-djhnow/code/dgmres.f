...
C     .. Array Arguments ..
     ...
     +                 SX(N), X(N)
      INTEGER IA(NELT), IGWK(LIGW), IWORK(*), JA(NELT), nnn, mpierr
...
C   ------------------------------------------------------------------
      ...
      nnn = n
      call mpi_allreduce(mpi_in_place,nnn,1,mpi_integer,mpi_sum,
...
C   ------------------------------------------------------------------
 ...
 10      CONTINUE
         ...
         call mpi_allreduce(mpi_in_place,sum,1,mpi_double_precision,
